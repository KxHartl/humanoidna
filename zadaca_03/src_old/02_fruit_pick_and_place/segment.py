...
def _extract_target_instances_from_pair(
    ...
    # Filter out anything further than 1.2m away just like in test_icp_params.py
    valid_3d = valid_3d & (points_grid[:, :, 2] > 0.0) & (points_grid[:, :, 2] < 1.2)

    # RANSAC table removal uklonjen kako bi YOLO maska preuzela potpunu kontrolu i ne bi odsijecala dno voća.
